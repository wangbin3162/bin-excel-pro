 ...
 * @param worksheet
 */
const setColumnWidth = function (columnWidth, worksheet) {
 ...
 * @param excelType
 */
const setRowHeight = function (rowHeight, worksheet, excelType) {
 ...
 * @param workbook
 */
const setImages = function (images, worksheet, workbook) {
 ...
 * @param worksheet
 */
const setRowHidden = function (rowhidden = {}, worksheet) {
 ...
 * @param worksheet
 */
const setColHidden = function (colhidden = {}, worksheet) {
...
const fillConvert = function (bg) {
  ...
  let fill = {
    ...
    pattern: 'solid',
    fgColor: {
      argb: bg.startsWith('#') ? bg.replace('#', '') : colorRGBtoHex(bg).replace('#', ''),
    },
  }
  return fill
}
